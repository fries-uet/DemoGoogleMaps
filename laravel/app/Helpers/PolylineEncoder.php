...
class PolylineEncoder {
	 ...
	 *
	 * Example: PolylineEncoder::decodeValue( 'kxj_CgbsdS|JbAxEf@nMlAfD\\rBNfBD~AAxAEtAK~AS|A]vA]fA_@~@a@rAm@pAu@~AkAvLcJbAw@tC}Bzh@u`@fF_E~CcCzC_CpK_I`NkKnFcEfCoBpBuAr]mW' );
	 *
	 * @param $value
	 *
	 * @return array
